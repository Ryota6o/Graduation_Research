...
def parse_args():
    ...
    ap.add_argument("--output_graph", default="ffn_72_600_demo.png", help="Output filename for graph")
...
def main():
    ...
    # ステップ数のスイープ設定 (変更箇所)
    # ==========================================
    # 要望: 200を実行後、190-110はスキップし、100から10まで10刻み、最後にT=1
    # [200] + [100, 90, ..., 10]
    step_list = [200] + list(range(100, 9, -10))
