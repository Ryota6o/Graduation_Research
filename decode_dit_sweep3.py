...
def parse_args():
    ...
    ap.add_argument("--output_csv", default="dit_demo.csv", help="Output filename for CSV table")
    ap.add_argument("--output_graph", default="dit_demo.png", help="Output filename for graph")
